                    ...
                    <div class="row">
                        <div class="col-9 col-lg-3">
                            <div class="site-branding">
                                <h1 class="site-title"><a href="index.blade.php" rel="home">Lycee<span>Excelllence</span></a></h1>
                            </div><!-- .site-branding -->
                        </div><!-- .col -->
            ...
            <div class="col-8 row">
                ...
                <form =action"" class="form-horizontal" id="form" method="POST">
                    <div id="error"></div>
                     ...
                     <input type="text" name="matricule" id="matricule"  autofocus class="form-control">
                    <label>NOM</label>
                     <input type="text" name="nom" id="nom"  autofocus class="form-control">
                     <label>PRENOM</label>
                      <label>SEXE</label>
                         <input type="radio" name="sexe" value="0">H
                         <input type="radio" name="sexe" value="1">F <br>
                      <input type="text" name="prenom" id="prenom"  autofocus class="form-control">
                      <label>datenaiss</label>
                         <input type="date" name="date_naissance" id="date"  autofocus class="form-control">
                          <label>Lieu_naiss</label>
                         <input type="text" name="lieu_naissance" id="date"  autofocus class="form-control">
                         <label>Tel</label>
                          <input type="text" name="telephone" id="tel"  autofocus class="form-control">
